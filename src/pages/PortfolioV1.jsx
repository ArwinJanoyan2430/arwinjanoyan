...
import PortfolioV2 from "../pages/PortfolioV2.jsx";
      ...
      >
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 mb-5">
          ...
          <div className="flex-1 w-full text-center md:text-left">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mt-5 w-full">
              <button
              ...
              <button
                className="button-3 col-span-2 md:col-span-1 h-8 bg-zinc-600 flex items-center justify-center rounded-lg bg-foreground px-4 text-xs font-medium text-background transition-all duration-200 hover:bg-foreground/90 hover:-translate-y-0.5 gap-2 whitespace-nowrap text-white dark:text-white"
                onClick={() => navigate("/v2")}
              >
                <FileText size={16} />
                View Portfolio V2
